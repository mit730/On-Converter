        ...
        case '10':
            for(let i = 0; i < input.length; i++) {
                if(isNaN(input.charAt(i))) {
                    error.style.display = 'block';
                    error.textContent = `Error : Decimal number does not include '${input.charAt(i)}'. Please enter only decimal number or select different base for input number`;
                    return false;
                }
            }
        ...
        case '8':
            for(let i = 0; i < input.length; i++) {
                if(input.charAt(i) == '8' || input.charAt(i) == '9' || isNaN(input.charAt(i))) {
                    error.style.display = 'block';
                    error.textContent = `Error : Octal number does not include '${input.charAt(i)}'. Please enter only octal number or select different base for input number`;
                    return false;
                }
            }
        ...
        case '16':
            for(let i = 0; i < input.length; i++) {
                ...
                && input.charCodeAt(i) <= 70))) {
                    error.style.display = 'block';
                    error.textContent = `Error : Hexadecimal number does not include '${input.charAt(i)}'. Please enter only hexadecimal number or select different base for input number`;
                    return false;
                }
            }
